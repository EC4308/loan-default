...
combined_data = subset(combined_data, select = -c(grade, sub_grade, desc, title, emp_title, zip_code, loan_status, id, member_id, earliest_cr_line, last_credit_pull_d, next_pymnt_d, issue_d, last_pymnt_d))
```
