...
combined_data$last_pymnt_d <- dmy(paste("01", combined_data$last_pymnt_d, sep = "-"))
...
combined_data %>% 
  left_join(delinquency_rate, by = c("last_pymnt_d" = "DATE")) -> combined_data
```
...
combined_data = subset(combined_data, select = -c(grade, sub_grade))
```
